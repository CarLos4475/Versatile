...
class SeedData {
  ...
  static const List<Exercise> exercises = [
    ...
    Exercise(id: 'ex-7',  name: 'Squat',                  muscle: 'Quadriceps', equipment: 'Barbell'),
    Exercise(id: 'ex-8',  name: 'Romanian Deadlift',      muscle: 'Hamstrings', equipment: 'Barbell'),
    Exercise(id: 'ex-9',  name: 'Leg Press',              muscle: 'Quadriceps', equipment: 'Machine'),
    ...
    Exercise(id: 'ex-13', name: 'Bicep Curl',             muscle: 'Biceps',    equipment: 'Dumbbell'),
    Exercise(id: 'ex-14', name: 'Tricep Pushdown',        muscle: 'Triceps',   equipment: 'Cable'),
    Exercise(id: 'ex-15', name: 'Hammer Curl',            muscle: 'Biceps',    equipment: 'Dumbbell'),
  ...
  static const List<Session> sessions = [
    Session(
      ...
      exercises: [
        ...
        SessionExercise(exerciseId: 'ex-14', name: 'Tricep Pushdown', muscle: 'Triceps', sets: [
